...
export const weatherCodeMap = {
  ...
  1: { condition: 'Mainly clear', icon: '🌤️', background: 'bg-sunny-gradient' },
  ...
  48: { condition: 'Depositing rime fog', icon: '🌫️', background: 'bg-cloudy-gradient' },
  51: { condition: 'Light drizzle', icon: '🌦️', background: 'bg-rainy-gradient' },
  53: { condition: 'Moderate drizzle', icon: '🌦️', background: 'bg-rainy-gradient' },
  ...
  61: { condition: 'Slight rain', icon: '🌦️', background: 'bg-rainy-gradient' },
  ...
  66: { condition: 'Light freezing rain', icon: '🌨️', background: 'bg-snowy-gradient' },
  ...
  75: { condition: 'Heavy snow fall', icon: '❄️', background: 'bg-snowy-gradient' },
  77: { condition: 'Snow grains', icon: '❄️', background: 'bg-snowy-gradient' },
  80: { condition: 'Slight rain showers', icon: '🌦️', background: 'bg-rainy-gradient' },
  81: { condition: 'Moderate rain showers', icon: '🌧️', background: 'bg-rainy-gradient' },
  82: { condition: 'Violent rain showers', icon: '⛈️', background: 'bg-rainy-gradient' },
  85: { condition: 'Slight snow showers', icon: '🌨️', background: 'bg-snowy-gradient' },
  86: { condition: 'Heavy snow showers', icon: '❄️', background: 'bg-snowy-gradient' },
  95: { condition: 'Thunderstorm', icon: '⛈️', background: 'bg-rainy-gradient' },
  96: { condition: 'Thunderstorm with slight hail', icon: '⛈️', background: 'bg-rainy-gradient' },
  99: { condition: 'Thunderstorm with heavy hail', icon: '⛈️', background: 'bg-rainy-gradient' }
};
